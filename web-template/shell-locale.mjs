...
const english = new Map([
  ...
  ['Kompetenzhaus in 3D. Im Erkundungsmodus mit W A S D bewegen. Escape gibt den Mauszeiger frei.', 'Kompetenzhaus in 3D. Move with W A S D in exploration mode. Escape releases the mouse.'],
  ...
  ['Bewegen', 'Move'], ['Maus freigeben', 'Release mouse'], ['E · Lernort', 'E · learning place'],
  ...
  ['Türen verbinden Räume an einer gemeinsamen Wand. Treppen brauchen freie Felder genau übereinander und verbinden zwei benachbarte Geschosse.', 'Doors connect rooms along a shared wall. Stairs need clear tiles directly above each other on adjacent floors.'],
  ...
  ['Lautstärke', 'Volume'], ['Textgrösse', 'Text size'], ['Bewegung reduzieren', 'Reduce motion'], ['Kontrast verstärken', 'Increase contrast'], ['Akustische Hinweise auch anzeigen', 'Also display sound cues'], ['Blickempfindlichkeit', 'Look sensitivity'], ['Einstellungen übernehmen', 'Apply settings'],
