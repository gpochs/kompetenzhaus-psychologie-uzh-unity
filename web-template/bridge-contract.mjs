export const COMMANDS = new Set([
  ...
  'userGesture', 'setArchitectureView',
]);
...
export function buildTutorContext(state, catalog) {
  ...
  if (['2.0.0-draft', '2.1.0-draft'].includes(state.frameworkProfile?.frameworkVersion)) envelope.frameworkVersion = state.frameworkProfile.frameworkVersion;
  return envelope;
}
